...
class prepro_cls_DatasetBD_v2(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        #poison_indicator是一个中毒标志数组，0表示样本是干净的，1表示样本是中毒的
    ...
    def prepro_backdoor(self): #遍历整个数据集，
    ...
    def set_one_bd_sample(self, selected_index, img, bd_label, label): #保存中毒样本
